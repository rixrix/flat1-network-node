...
pub mod pallet {
	...
	#[derive(Clone, Encode, Decode, PartialEq, Copy, RuntimeDebug, TypeInfo, MaxEncodedLen)] // @TODO: need to review
	...
	// @NOTE: more discussion `generate_store`
	// - https://substrate.stackexchange.com/q/1354
	// - https://substrate.stackexchange.com/a/1323
	...
	impl<T: Config> Pallet<T> {
		...
		// An internal function for purchasing a colletible
	...
	// @TODO https://docs.substrate.io/tutorials/collectibles-workshop/08-add-collectibles-to-runtime/
}
